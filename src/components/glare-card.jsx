...
export const GlareCard = ({
  ...
  return (
    (<div
      ...
      className="relative isolate [contain:layout_style] [perspective:1000px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[220px] [aspect-ratio:17/21] cursor-pointer"
      ref={refElement}
      onPointerMove={(event) => {
